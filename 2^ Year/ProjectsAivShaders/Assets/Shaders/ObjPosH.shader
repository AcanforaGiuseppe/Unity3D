//Come modificare questo shader in modo che il VS non cambi il coordinate space del vertice
//Quindi il vertice gli viene dato in obj space e viene passato come output dal VS sempre
//in obj space

//o.pos= mul(UNITY_MATRIX_MVP, v.vertex); //Projection space
//diventa
//o.pos= v.vertex; //Object space

//Quello che otteniamo su unity é un object space trasformato in screen space
//Il cubo si adatta alla view port


//====
//Coloriamo l'oggetto in due colori

Shader "Custom/ObjPosH"
{
    Properties{
    ...
    Subshader
    {
        ...
        Pass
        {
            ...
            //fine di tutte le operazioni fatte in frag ovvero il colore
            {
                ...
                //_ScreenParams che vale quanto vale la risoluzione dell'output
                //cioe se siamo in HD varra 0 1920 0 1080
                

                return _Color * (i.pos.x/_ScreenParams.x); //il cubo cosi se sta tutto a sx
                //tende verso il colore nero, a dx tende verso il rosso
            }
