Shader "Custom/transparentShaderH"
{
    Properties{
        ...
        [Enum(UnityEngine.Rendering.BlendMode)] _BlendDst ("Blend DRC", Float) = 1
        [Enum(UnityEngine.Rendering.BlendOp)] _BlendOp ("Blend OP", Float) = 1
        //Uso questo enum che mi dice tutti
        //i possibili blending mode anziche scriverli tutte le volte nel Pass
    }
    ...
    Subshader
    {
        ...
        Pass
        {
            Zwrite Off 
            //Additive
            //Blend One One //cosi partiamo da un blend additivo 1 1
            //BlendOp Add 
            //Questo blending viene fatto in automatico quindi non va cambiato il resto della struttura

            //Multiply
            //Blend DstColor Zero
            //BlendOp Add
            
            //Alpha blending (quello classico)
