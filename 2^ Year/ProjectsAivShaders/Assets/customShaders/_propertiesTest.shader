...
{
	Properties{ 
		//Sono tutte le proprieta del materiale che ha Sphere nella scena Shaders Start A01
		//Sono i cosidetti uniform, una volta impostati sono uguali sia per il VS sia per Fragment
		...
		_Cube("Example CubeMap", CUBE) = "" {} //cubemap
